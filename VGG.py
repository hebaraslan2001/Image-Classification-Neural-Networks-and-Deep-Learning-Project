...
def create_train_data():
    ...
    training_data = []
    testing_data=[]
    for folders in tqdm(os.listdir('E:/college/Year Four/First Term/Neural Networks & Deep Learning/project/dataset NN\'23/dataset/train')):
        num_of_folder = 'E:/college/Year Four/First Term/Neural Networks & Deep Learning/project/dataset NN\'23/dataset/train' + "/" + str(folders)
        c=0
...
if (os.path.exists('E:/college/Year Four/First Term/Neural Networks & Deep Learning/project/VGG_model.tfl')):
...
with open("47.csv", "w", newline="") as f:
    ...
    for image in tqdm(os.listdir('E:/college/Year Four/First Term/Neural Networks & Deep Learning/project/dataset NN\'23/dataset/test')):
        img = cv2.imread(os.path.join('E:/college/Year Four/First Term/Neural Networks & Deep Learning/project/dataset NN\'23/dataset/test', image), 0)
